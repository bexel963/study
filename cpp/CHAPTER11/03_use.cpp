...
int main()
{
	...
	total1 = jennySt + bennySt;		// == total1 = jennySt.operator+(bennySt);	// 멤버 함수
	cout << "total1 = " << total1 << std::endl;	
	total2 = jennySt - bennySt;		// == total2 = operator+(jennySt, bennySt);	// 프렌드 함수
	cout << "total2 = " << total2 << std::endl;

	//total3 = jennySt + kennyD;	// ?????
