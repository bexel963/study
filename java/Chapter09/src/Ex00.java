/*
  < java.lang패키지 >
	  ...
	  1. Object클래스 : 멤버변수는 없고 오직 11개의 메서드만 가지고 있음.
	  ...
	  2. String클래스
	  		...
	  		- 문자형 배열 참조변수 char[] value 를 인스턴스 변수로 정의해 놓고 있다.
	  ...
	  4. Math 클래스
	  		...
	  		- static long round(double a)	- 일반적인 반올림
	  		- static long round(float a)
	  		- static double rint(double a)	- 두 정수의 정가운데 있는 값은 가장 가까운 짝수 정수를 반환.
