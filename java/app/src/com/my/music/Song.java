...
public class Song {
	...
	Song(String artist, String name, int playTimeInMilliSeconds){
		this.artist = artist;
		this.name = name;
	...
	public void play() {
		System.out.println(String.format(
				"Playing %s by %s. Duration is %d milliseconds%s", this.name, this.artist, this.playTimeInMilliSeconds, System.lineSeparator()));
