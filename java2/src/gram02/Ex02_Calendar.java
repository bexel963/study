...
public class Ex02_Calendar {
    public static void main(String[] args) {
        ...
        String currentPrint = String.format("현재 : %d년 %d월 %d일 %s요일",
                current.get(Calendar.YEAR), current.get(Calendar.MONTH), current.get(Calendar.DATE), DAY_OF_WEEK[current.get(Calendar.DAY_OF_WEEK)]);
        // 1/1000초로 변환
